...
export default function ContactPage() {
  return (
    ...
    <div className="bg-[--dark-shade] px-4 py-24 md:flex gap-12 justify-center ">
             <div className="">
      <h2 className="text-3xl font-semibold mb-4 text-[#7ED6DF]">Contact Us</h2>
        {/* <Formcontainer> */}
        <ContactForm />
        {/* </Formcontainer> */}
      </div>
      ...
      <MapPinCheck color="#7ED6DF" />
        ...
        <p>Tesmouth house,Hamburgshire, Geneva, Switzerland</p>
      </div> 
      <div>
        <div className="flex gap-2">
