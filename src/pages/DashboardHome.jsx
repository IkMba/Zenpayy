...
import { Banknote, CircleUser, DollarSign, Lock, Shield, TrendingUp, User } from 'lucide-react'
  ...
  return (
    <div className='py-12 px-4 w-screen md:w-full '>
        ...
        <div className='flex gap-4 justify-end'>
          ...
          <Link to='transfer' className='px-4 py-2 md:px-10 md:py-4 bg-[#7B17E5] rounded-lg text-white'>Withdraw</Link>
        </div>
        </div>
    <div className='flex gap-4 py-2 overflow-x-scroll w-full md:w-full md:overflow-hidden'>
      ...
      <DashCards title="Flex Total" amount="$0.00" bgColor="bg-[--blue]" size="md" icon={<DollarSign />}/>
      {/* <DashCards title="Total Savings" amount="$0.00" bgColor="bg-[--blue]" size="md" icon={<Shield />}/> */}
    </div>
    <div className='lg:flex gap-8 w-full'>
        ...
        <h3 className='text-lg py-4'>Your transactions appear here. No transactions made.</h3>
