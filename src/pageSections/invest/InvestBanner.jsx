...
export default function InvestBanner() {
  return (
    <div className='about-banner px-8 py-20 text-white' >
      ...
      <h3  className='text-4xl font-extrabold uppercase my-2 lg:my-6 lg:text-5xl'>Invest on the go</h3>
      <p className='font-medium mb-8'>Invest securely and confidently on the go.
